 ...
 * @author adity
 */
public class SupplyManagerViewHandlers extends javax.swing.JPanel {
    ...
    public SupplyManagerViewHandlers(Ecosystem ecosystem, OrganizationDirectory orgList) {
        initComponents();
    ...
    private void populateData(){
        ...
        for(UserAccount ua: userList){
            ...
            if(ua.getRole().toString().equals(Role.RoleType.Handler.toString())){
                
                HandlerRole role = (HandlerRole) ua.getRole();
