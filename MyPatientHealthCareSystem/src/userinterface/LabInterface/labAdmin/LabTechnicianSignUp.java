...
public class LabTechnicianSignUp extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(lblGender, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 230, -1, -1));

        lblTitle.setFont(new java.awt.Font("Georgia", 1, 24)); // NOI18N
        lblTitle.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblTitle.setText("Create Technician Profile");
        add(lblTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 20, 410, -1));

        lblPhoneNo.setFont(new java.awt.Font("Georgia", 0, 14)); // NOI18N
        lblPhoneNo.setText("Phone No.");
        add(lblPhoneNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 270, -1, -1));
        add(txtDateOfBirth, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 300, 238, -1));

        lblAddress.setFont(new java.awt.Font("Georgia", 0, 14)); // NOI18N
        lblAddress.setText("Address");
        add(lblAddress, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 350, -1, -1));
        ...
        add(btnSignUp, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 500, -1, -1));
        add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 100, 238, -1));
        ...
        add(txtState, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 420, 238, -1));
        add(txtAddress, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 340, 238, -1));
        ...
        add(txtPhoneNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 260, 238, -1));

        lblZipCode.setFont(new java.awt.Font("Georgia", 0, 14)); // NOI18N
        lblZipCode.setText("Zipcode");
        add(lblZipCode, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 470, -1, -1));

        lblDateOfBirth.setFont(new java.awt.Font("Georgia", 0, 14)); // NOI18N
        lblDateOfBirth.setText("Date Of Birth");
        add(lblDateOfBirth, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 310, -1, -1));

        lblCity.setFont(new java.awt.Font("Georgia", 0, 14)); // NOI18N
        lblCity.setText("City");
        add(lblCity, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 390, -1, -1));

        cboxGender.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Male", "Female", "Others" }));
        add(cboxGender, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 220, 238, -1));
        ...
        add(txtCity, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 380, 238, -1));

        lblOrgName.setFont(new java.awt.Font("Georgia", 0, 14)); // NOI18N
        lblOrgName.setText("Organization Name");
        add(lblOrgName, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 190, -1, -1));

        lblState.setFont(new java.awt.Font("Georgia", 0, 14)); // NOI18N
        lblState.setText("State");
        add(lblState, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 430, -1, -1));
        add(txtZipcode, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 460, 238, -1));

        lblUsername.setFont(new java.awt.Font("Georgia", 0, 14)); // NOI18N
        lblUsername.setText("Email");
        add(lblUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 150, -1, -1));

        lblName.setFont(new java.awt.Font("Georgia", 0, 14)); // NOI18N
        lblName.setText("Name");
        add(lblName, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 110, -1, -1));
        add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 140, 238, -1));
        ...
        add(organizationJComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 180, 238, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/LabTechSignUp.jpg"))); // NOI18N
        ...
        try{
            if(EmpytyFieldValidation()){
                ...
                if(RegexValidation()){
                    ...
                    String LabName = organizationJComboBox.getSelectedItem().toString();
